      ...
      <div style={styles.card}>
        ...
        <section style={styles.section}>
          ...
          <p style={styles.p}>
            ...
            reconheça seu dispositivo e armazene informações sobre suas
            preferências.
          </p>
        </section>
        ...
        <section style={styles.section}>
          ...
          <p style={styles.p}>
            O site de verificação de receitas (renovejasaude.com.br/verify)
            atualmente <strong>não utiliza cookies</strong>. A página serve
            exclusivamente para validar receitas por código e disponibilizar a
            2ª via quando aplicável.
          </p>
        </section>
        ...
        <section style={styles.section}>
          ...
          <p style={styles.p}>
            Se no futuro implementarmos cookies (por exemplo, para analytics ou
            funcionalidades adicionais), esta política será atualizada. Os
            cookies serão utilizados de forma transparente, com base legal
            adequada (consentimento quando exigido pela LGPD) e com a
            possibilidade de gerenciamento pelas configurações do navegador.
          </p>
        </section>
