  ...
  const handleRevoke = async () => {
    ...
    try {
      await revokeCertificate(
        certInfo.id,
        revokeReason || 'Revogado pelo médico'
      );
    ...
    <DoctorLayout>
      <div className="max-w-2xl space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              ICP-Brasil A1 para assinatura de documentos
            </p>
          </div>
        </div>
        ...
        {certInfo ? (
          ...
          >
            <Card
              className={`shadow-sm ${certInfo.isExpired ? 'border-destructive/50' : isExpiringSoon ? 'border-amber-300 dark:border-amber-700' : 'border-emerald-300 dark:border-emerald-700'}`}
            >
              ...
              <CardContent className="space-y-3">
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p
                      className={`flex items-center gap-1.5 font-medium ${certInfo.isExpired ? 'text-destructive' : isExpiringSoon ? 'text-amber-600' : ''}`}
                    >
        ...
        <Card className="shadow-sm">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Envie seu certificado digital ICP-Brasil A1 (arquivo .PFX ou .P12)
              para habilitar a assinatura eletrônica de receitas e pedidos de
              exame.
            </p>
        ...
        {/* Info card */}
        <Card className="border-blue-100 bg-blue-50/30 shadow-sm dark:border-blue-900 dark:bg-blue-950/20">
          <CardContent className="p-4">
            <div className="flex gap-3">
              ...
              <div className="space-y-1 text-sm text-muted-foreground">
                ...
                <p>
                  O certificado ICP-Brasil A1 é necessário para assinar
                  digitalmente receitas e pedidos de exame, conforme exigido
                  pela legislação brasileira.
                </p>
                <p>
                  Você pode obter seu certificado através de autoridades
                  certificadoras como Serpro, Certisign ou Soluti.
                </p>
              </div>
            </div>
          </CardContent>
      ...
      <Dialog open={revokeDialogOpen} onOpenChange={setRevokeDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Esta ação é irreversível. Você precisará enviar um novo
              certificado para continuar assinando documentos.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
