                  ...
                  {filteredPatients.map((p) => {
                    ...
                    return (
                      <button
                        ...
                        className="group flex w-full flex-col gap-3 rounded-xl p-3 text-left transition-colors hover:bg-muted/50 sm:flex-row sm:items-center sm:gap-4"
                      >
                        {/* Avatar + Info */}
