      ...
      <div style={styles.container}>
        <div style={styles.card} className="recuperar-card">
          ...
          <p style={styles.error}>
            O link de redefinição está incompleto ou expirou. Solicite uma nova
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card} className="recuperar-card">
        ...
        {state === 'loading' && (
          <p style={styles.loading}>Redefinindo senha…</p>
        )}

        {state === 'success' && (
          <div style={styles.success}>
            <p style={styles.successText}>✓ Senha alterada com sucesso!</p>
            <p style={styles.subtitle}>Faça login no app com a nova senha.</p>
            <Link to="/" style={styles.link}>
              Voltar ao início
            </Link>
          </div>
