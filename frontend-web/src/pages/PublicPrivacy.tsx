      ...
      <div style={styles.card}>
        ...
        <section style={styles.section}>
          ...
          <p style={styles.p}>
            ...
            E-mail:{' '}
            <a
              href="mailto:privacidade@renovejasaude.com.br"
              style={styles.link}
            >
        ...
        <section style={styles.section}>
          ...
          <p style={{ ...styles.p, marginTop: 8 }}>
            <strong>Dados de saúde:</strong> sintomas relatados, diagnósticos,
            prescrições médicas e transcrições de teleconsulta.
          </p>
          <p style={{ ...styles.p, marginTop: 8 }}>
            <strong>Dados de navegação:</strong> endereço IP, user-agent do
            navegador e timestamps de acesso.
          </p>
        </section>
        ...
        <section style={styles.section}>
          ...
          <ul style={styles.ul}>
            <li style={styles.li}>
              <strong>Prestação de serviço de saúde</strong> — tutela da saúde
              do titular (Art. 7º, VIII e Art. 11, II, "f" da LGPD).
            </li>
            <li style={styles.li}>
              <strong>Cumprimento de obrigação legal e regulatória</strong> —
              normas do CFM e ANVISA.
            </li>
            <li style={styles.li}>
              <strong>Consentimento explícito para uso de IA</strong> — análise
              assistida por inteligência artificial (Art. 11, I da LGPD).
            </li>
          </ul>
        </section>
        ...
        <section style={styles.section}>
          ...
          <ul style={styles.ul}>
            <li style={styles.li}>
              <strong>Médicos credenciados:</strong> para a prestação do serviço
              de teleconsulta.
            </li>
            <li style={styles.li}>
              <strong>OpenAI:</strong> análise por inteligência artificial, sem
              retenção de dados de saúde pelo provedor.
            </li>
            <li style={styles.li}>
              <strong>Daily.co / Deepgram:</strong> infraestrutura de
              videochamada e transcrição de teleconsulta.
            </li>
            <li style={styles.li}>
              <strong>AWS (Amazon Web Services):</strong> infraestrutura de
              hospedagem e armazenamento, com dados na região sa-east-1 (São
              Paulo).
            </li>
          </ul>
        </section>
        ...
        <section style={styles.section}>
          ...
          <ul style={styles.ul}>
            <li style={styles.li}>
              <strong>Prontuário médico:</strong> 20 anos, conforme CFM
            ...
            <li style={styles.li}>
              <strong>Dados de conta:</strong> período ativo + 5 anos após
              inativação.
            </li>
          </ul>
        </section>
        ...
        <section style={styles.section}>
          ...
          <ul style={styles.ul}>
            <li style={styles.li}>
              Comunicação criptografada via HTTPS com TLS 1.3;
            </li>
            <li style={styles.li}>
              Criptografia de dados em repouso com AES-256;
            </li>
            <li style={styles.li}>
              Assinatura digital de documentos com certificado ICP-Brasil;
            </li>
            <li style={styles.li}>
              Web Application Firewall (WAF) para proteção contra ataques;
            </li>
            <li style={styles.li}>
              Trilha de auditoria (audit trail) para rastreabilidade de acessos
              e ações.
            </li>
          </ul>
        </section>
        ...
        <section style={styles.section}>
          ...
          <p style={styles.p}>
            ...
            recente estará sempre disponível nesta página. Última atualização:
            abril de 2026.
          </p>
        </section>
