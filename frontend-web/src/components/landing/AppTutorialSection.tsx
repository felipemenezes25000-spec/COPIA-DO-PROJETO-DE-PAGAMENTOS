    ...
    items: [
      {
        ...
        description:
          'Fluxos para receita simples, controlada, exames e documentos digitais.',
      },
      {
        icon: HeartPulse,
        title: 'Acompanhamento e prontuário',
        description:
          'Histórico, notificações e visualização de documentos assinados em um único lugar.',
      },
      {
        icon: Video,
        title: 'Teleconsulta online e orientação',
        description:
          'Acesso a jornadas de atendimento remoto quando a avaliação clínica exigir contato síncrono entre paciente e médico.',
      },
    ],
  },
  doctor: {
    ...
    items: [
      {
        ...
        description:
          'Resumo do caso, leitura documental e organização de informações para revisão mais ágil, sem substituir o julgamento clínico.',
      },
      {
        icon: Stethoscope,
        title: 'Fila, revisão e edição',
        description:
          'Avaliação do pedido, ajuste de dados clínicos e aprovação conforme julgamento profissional.',
      },
      {
        icon: ShieldCheck,
        title: 'Assinatura e validade',
        description:
          'Documentos com assinatura digital, rastreabilidade e validação pública por QR Code.',
      },
    ],
  },
  management: {
    ...
    items: [
      {
        ...
        description:
          'Eventos rastreados, trilhas de decisão e apoio a políticas internas e obrigações regulatórias.',
      },
      {
        icon: Activity,
        title: 'Visibilidade operacional',
        description:
          'Status de jornadas, filas, pagamentos, documentos emitidos e indicadores de uso.',
      },
      {
        icon: BrainCircuit,
        title: 'Evolução e integração',
        description:
          'Base para parcerias com hospitais, clínicas, operadoras e estruturas públicas de saúde.',
      },
    ],
  },
};
...
export function AppTutorialSection() {
  ...
  return (
    <section
      id="features"
      className="relative overflow-hidden bg-gradient-to-b from-background via-accent/15 to-background py-16 sm:py-24 lg:py-32"
    >
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          ...
          <p className="mt-6 text-lg text-muted-foreground">
            A proposta aqui é mostrar, de forma objetiva, como a plataforma pode
            apoiar modelos públicos e privados de telemedicina online sem abrir
            mão de governança clínica, rastreabilidade e decisão final do
            médico.
          </p>
        </motion.div>
        ...
        <div
          role="tablist"
          aria-label="Perfis de uso da plataforma"
