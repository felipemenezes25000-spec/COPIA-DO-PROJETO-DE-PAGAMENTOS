      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          ...
          <p className="mt-6 text-lg text-muted-foreground">
            O desafio não é apenas digitalizar documentos. Em muitos cenários,
            também envolve reduzir fricção operacional, organizar a demanda e
        ...
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
          ...
          >
            ...
            <h3 className="font-display text-xl font-bold text-foreground sm:text-2xl">
              Operações de saúde exigem escala com governança.
            </h3>
            <p className="mt-4 text-base leading-relaxed text-muted-foreground">
              A proposta da plataforma é apoiar instituições a organizar
              jornadas recorrentes sem substituir a avaliação clínica,
              preservando rastreabilidade, segurança documental e
