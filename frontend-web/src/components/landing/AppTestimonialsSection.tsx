...
const upcomingFeatures = [
  {
    ...
    title: 'Receita Azul',
    description:
      'Expansão planejada para fluxos específicos com controles adicionais e governança própria.',
  },
  {
    icon: BadgePlus,
    title: 'Receita Amarela',
    description:
      'Evolução gradual da plataforma para novas jornadas reguladas, com implementação faseada.',
  },
  {
    icon: Building2,
    title: 'Integração com prontuário institucional',
    description:
      'Conexão progressiva com rotinas hospitalares, clínicas e redes de atenção para reduzir retrabalho.',
  },
  {
    icon: ServerCog,
    title: 'APIs para parceiros',
    description:
      'Base para interoperabilidade com sistemas de gestão, portais e fluxos próprios de atendimento.',
  },
  {
    icon: FlaskConical,
    title: 'Ampliação de casos de uso',
    description:
      'Mais tipos de documentos, critérios e jornadas conforme evolução operacional e regulatória.',
  },
];
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          ...
          <p className="mt-6 text-lg text-muted-foreground">
            A proposta não é parar em um fluxo único. O roadmap foi pensado para
            ampliar cobertura documental, integrações e capacidade institucional
            ao longo do tempo.
          </p>
        </motion.div>
