    ...
    <>
      <motion.header
        ...
        className={`fixed left-0 right-0 top-0 z-50 transition-all duration-500 ${
          isScrolled
            ? 'border-b border-border/50 bg-card/95 shadow-elevated backdrop-blur-xl'
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-x-0 top-16 z-50 mx-3 overflow-hidden rounded-2xl border border-border/50 bg-background/95 shadow-elevated backdrop-blur-xl sm:top-20 sm:mx-4 lg:hidden"
            >
              <nav
