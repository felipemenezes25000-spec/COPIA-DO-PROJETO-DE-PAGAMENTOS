...
function MiniTag({
  ...
  return (
    <span
      className={`rounded-full px-2 py-1 text-[10px] font-semibold ${toneClasses[tone]}`}
    >
      {children}
    </span>
  );
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        ...
        <MiniCard>
          <p className="mb-3 text-xs font-bold text-slate-900">
            Status do pedido
          </p>
        ...
        <MiniCard>
          <div className="flex items-start justify-between gap-2">
            <div>
              ...
              <p className="mt-1 text-[11px] text-slate-500">
                Emitido após avaliação clínica
              </p>
            </div>
            <span className="rounded-full bg-emerald-100 px-2 py-1 text-[10px] font-semibold text-emerald-700">
              Assinado
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500">
                Atendimento por vídeo com profissional de saúde
              </p>
            </div>
          </div>
        ...
        <MiniCard tone="primary">
          <div className="flex items-start gap-2">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-xs font-bold text-slate-900">
                Dra. Renoveja resumiu a consulta
              </p>
              <p className="mt-1 text-[11px] leading-relaxed text-slate-600">
                Cefaleia ha 3 dias, sem febre, piora no fim da tarde e melhora
                parcial com repouso.
              </p>
              <div className="mt-2 flex flex-wrap gap-1.5">
                <MiniTag tone="warning">
                  Sintoma principal: dor de cabeca
                </MiniTag>
        ...
        <div className="space-y-2">
          ...
          <MiniCard>
            <div className="flex items-start gap-2">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-xs font-bold text-slate-900">
                  CID sugerido pela IA
                </p>
                <p className="mt-1 text-[11px] text-slate-600">
                  R51 - Cefaleia
                </p>
                <p className="mt-1 text-[10px] leading-relaxed text-slate-500">
                  Sugestão automática para apoio. O médico pode confirmar,
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-2 text-[10px] leading-relaxed text-slate-500">
                  Lista apenas de apoio clínico. Prescrição e orientação final
                  dependem da avaliação médica.
                </p>
              </div>
            </div>
          </MiniCard>
          ...
          <MiniCard>
            <div className="flex items-start gap-2">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-xs font-bold text-slate-900">
                  Documentação científica consultada
                </p>
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="mt-1 text-[11px] leading-relaxed text-emerald-700">
                Conduta aprovada após avaliação clínica. A IA apoia a
                organização da consulta, mas a decisão final, a orientação e a
                prescrição são exclusivamente médicas.
              </p>
            </div>
          </div>
        </MiniCard>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="mt-4 text-base text-muted-foreground sm:mt-6 sm:text-lg">
            Uma amostra da jornada digital que ajuda instituições a organizar
            solicitações, validar documentos e ampliar acesso com mais
        ...
        >
          <div className="inline-flex max-w-full items-center gap-2 rounded-full border border-success/20 bg-success/10 px-4 py-2 shadow-card sm:gap-3 sm:px-6 sm:py-3">
            <div className="h-2.5 w-2.5 flex-shrink-0 rounded-full bg-success" />
            <span className="text-left text-xs font-medium text-foreground sm:text-sm">
              Telas baseadas no{' '}
              <strong className="text-success">app real em modo claro</strong>,
              com jornadas de envio, acompanhamento e documentos.
            </span>
            <Clock3 className="hidden h-5 w-5 flex-shrink-0 text-success sm:block" />
          </div>
        </motion.div>
