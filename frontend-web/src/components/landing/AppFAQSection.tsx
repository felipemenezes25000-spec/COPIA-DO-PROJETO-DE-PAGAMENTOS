      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="mt-6 text-lg text-muted-foreground">
            O posicionamento institucional do RenoveJá+ é voltado a organizações
            que precisam organizar jornadas, manter governança clínica e
            estruturar melhor fluxos recorrentes com apoio digital.
          </p>
        </motion.div>
