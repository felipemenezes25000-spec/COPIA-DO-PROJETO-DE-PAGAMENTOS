      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          ...
          <h2 className="font-display text-2xl font-bold text-white sm:text-4xl lg:text-5xl">
            Telemedicina online com responsabilidade clínica, jurídica e
            operacional.
          </h2>
          <p className="mt-6 text-lg text-white/70">
            Esta seção destaca os pilares de confiança necessários para adoção
            por governo, hospitais, clínicas, operadoras e demais parceiros
            institucionais, com IA assistiva e decisão final sempre do médico.
          </p>
        </motion.div>
