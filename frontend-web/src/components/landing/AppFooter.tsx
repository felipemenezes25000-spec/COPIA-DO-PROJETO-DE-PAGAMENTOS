      ...
      <div className="border-b border-[#25D366]/30 bg-[#25D366]/10">
        <div className="container mx-auto px-4 py-5">
          <div className="mx-auto flex max-w-4xl items-start gap-3 sm:gap-4">
            <div className="mt-0.5 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-[#25D366] sm:h-10 sm:w-10">
              <CheckCircle2 className="h-4 w-4 text-white sm:h-5 sm:w-5" />
            </div>
            <div className="text-sm">
              <p className="mb-2 text-sm font-bold text-white sm:text-base">
                Serviço com foco em conformidade e responsabilidade clínica
              </p>
              <p className="leading-relaxed text-white/80">
                O RenoveJá+ foi estruturado para apoiar telemedicina e jornadas
                documentais com uso responsável de IA, proteção de dados,
                rastreabilidade operacional e decisão final sempre do médico.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="border-b border-amber-500/30 bg-amber-500/10">
        <div className="container mx-auto px-4 py-4">
          <div className="mx-auto flex max-w-4xl items-start gap-3 sm:items-center">
            <AlertTriangle className="mt-0.5 h-5 w-5 flex-shrink-0 text-amber-400 sm:mt-0" />
            <p className="text-sm text-white/90">
              <span className="font-bold text-amber-400">Aviso:</span> este site
              não representa atendimento de urgência ou emergência. Em casos
              graves, procure assistência presencial ou ligue para o{' '}
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
          <div>
            ...
            <p className="mb-6 max-w-md text-sm leading-relaxed text-white/70">
              Plataforma de telemedicina para apoiar fluxos assistenciais e
              documentais com tecnologia, conformidade e rastreabilidade.
            </p>
            ...
            <div className="space-y-3">
              ...
              >
                <div
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-[#25D366]/20 transition-colors group-hover:bg-[#25D366]"
                  aria-hidden="true"
                >
                ...
                <div>
                  ...
                  <span className="text-xs text-white/50">
                    WhatsApp / contato institucional
                  </span>
                </div>
              </a>
              <a
              ...
              >
                <div
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/20 transition-colors group-hover:bg-primary"
                  aria-hidden="true"
                >
                ...
                <li key={link.name}>
                  {link.href.startsWith('/') ? (
                    ...
                    <a
                      ...
                      aria-label={
                        link.href.startsWith('http')
                          ? `${link.name} (abre em nova aba)`
                          : link.href.startsWith('mailto:')
                            ? `Enviar email: ${link.name}`
                            : undefined
                      }
                      className="group flex items-center gap-2 py-1 text-sm text-white/70 transition-colors hover:text-primary"
                    >
      ...
      <div className="border-t border-white/10">
        <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-4 py-6 md:flex-row">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 text-xs sm:gap-3 sm:text-sm">
            <span className="flex items-center gap-1.5 rounded-full bg-white/10 px-3 py-2 text-white/80 sm:gap-2 sm:px-4 sm:py-2.5">
              <Shield className="h-3.5 w-3.5 text-primary sm:h-4 sm:w-4" />
              SSL/TLS
            </span>
            <span className="flex items-center gap-1.5 rounded-full bg-white/10 px-3 py-2 text-white/80 sm:gap-2 sm:px-4 sm:py-2.5">
              <CheckCircle2 className="h-3.5 w-3.5 text-[#25D366] sm:h-4 sm:w-4" />
              LGPD
            </span>
            <span className="flex items-center gap-1.5 rounded-full bg-white/10 px-3 py-2 text-white/80 sm:gap-2 sm:px-4 sm:py-2.5">
              <Shield className="h-3.5 w-3.5 text-primary sm:h-4 sm:w-4" />
