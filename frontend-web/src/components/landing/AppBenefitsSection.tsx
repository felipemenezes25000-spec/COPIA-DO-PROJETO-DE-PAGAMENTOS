      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          ...
          <h2 className="font-display text-2xl font-bold text-foreground sm:text-4xl lg:text-5xl">
            Telemedicina online com apoio operacional, rastreabilidade e
            responsabilidade clínica preservada.
          </h2>
          <p className="mt-6 text-lg text-muted-foreground">
            O RenoveJá+ foi desenhado para apoiar pacientes, médicos e gestores
            em jornadas digitais de telemedicina, com uso responsável de IA
            assistiva, fluxos auditáveis e decisão final sempre do médico.
          </p>
        </motion.div>
