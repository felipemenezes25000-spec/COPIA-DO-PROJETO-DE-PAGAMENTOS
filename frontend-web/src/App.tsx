...
const RhDashboard = lazy(() => import('@/pages/admin/rh/RhDashboard'));
const RhColaboradores = lazy(() => import('@/pages/admin/rh/RhColaboradores'));
const RhRecrutamento = lazy(() => import('@/pages/admin/rh/RhRecrutamento'));
const RhPonto = lazy(() => import('@/pages/admin/rh/RhPonto'));
const RhFerias = lazy(() => import('@/pages/admin/rh/RhFerias'));
const RhDesempenho = lazy(() => import('@/pages/admin/rh/RhDesempenho'));
const RhFolha = lazy(() => import('@/pages/admin/rh/RhFolha'));
