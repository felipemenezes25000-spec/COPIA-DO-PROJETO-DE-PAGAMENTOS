...
export const RENOVEJA_SERVICES: Record<ServiceType, RenovejaService> = {
  consulta_clinica: {
    ...
    price: 6.99,
    unit: 'por_minuto',
    description: 'Teleconsulta por vídeo com médico clínico geral.',
    costToDeliver: 4.2,
    marginPct: 39.9,
  },
  consulta_psico: {
    ...
    price: 3.99,
    unit: 'por_minuto',
    description: 'Teleconsulta por vídeo com psicólogo.',
    costToDeliver: 2.2,
    marginPct: 44.9,
  },
  receita_simples: {
  ...
  exame_lab: {
    ...
    unit: 'por_pedido',
    description:
      'Solicitação de exames laboratoriais (hemograma, glicemia, etc.).',
    costToDeliver: 3.0,
    marginPct: 84.9,
  },
  exame_imagem: {
    ...
    unit: 'por_pedido',
    description:
      'Solicitação de exames de imagem (ultrassonografia, raio-X, etc.).',
    costToDeliver: 3.0,
    marginPct: 90.0,
  },
  atestado: {
...
export const CONSULTATION_OUTCOMES: ConsultationOutcome[] = [
  {
    ...
    avgQuantity: 1.3,
    description:
      'Mais da metade das teleconsultas resultam em receituário simples.',
  },
  {
  ...
  },
  {
    ...
    avgQuantity: 1.5,
    description:
      'Solicitação de exames laboratoriais em teleconsultas investigativas.',
  },
  {
  ...
  },
  {
    ...
    avgQuantity: 1.0,
    description:
      'Atestado médico digital emitido na teleconsulta (sem custo adicional).',
  },
  {
...
export const PATIENT_PROFILES: PatientProfile[] = [
  {
    ...
    name: 'Jovem Saudável',
    description:
      'Faixa 18–30 anos, sem doenças crônicas. Usa teleconsulta para gripes, atestados e exames preventivos.',
  ...
  },
  {
    ...
    name: 'Adulto Crônico',
    description:
      'Faixa 30–60 anos, portador de doença crônica (hipertensão, diabetes, hipotireoidismo). Usa teleconsulta para renovar receitas e pedir exames.',
  ...
  },
  {
    ...
    description:
      'Acima de 60 anos, múltiplas comorbidades. Alta frequência de teleconsultas, receituários controlados e azul.',
  ...
  },
  {
    ...
    name: 'Saúde Mental',
    description:
      'Qualquer faixa etária. Teleconsultas frequentes com psicólogo por vídeo; alta taxa de receituário controlado.',
  ...
  },
  {
    ...
    name: 'Eventual',
    description:
      'Qualquer faixa etária. Usa a telemedicina raramente — principalmente para atestados digitais, exames rápidos ou renovação de receita.',
...
export function calcDerivativeRevenue(
  ...
  return outcomes
    .map((outcome) => {
      ...
      const volume =
        Math.round(
          patientCount * outcome.probability * outcome.avgQuantity * 100
        ) / 100;
...
export function calcTotalRevenuePerConsultation(
  ...
  const derivativeTotal = outcomes.reduce((sum, outcome) => {
    ...
    const expectedRevenue =
      outcome.probability * outcome.avgQuantity * service.price;
...
export function calcCityPotential(
  ...
  const revenuePerClinica = calcTotalRevenuePerConsultation(
    avgDurationMin,
    'clinica'
  );
  const revenuePerPsico = calcTotalRevenuePerConsultation(
    avgDurationMin,
    'psico'
  );
  ...
  const annualRevenue =
    Math.round(annualConsultations * revenuePerConsultation * 100) / 100;
...
export const PRICE_RECEITA_CONTROLADA =
  RENOVEJA_SERVICES.receita_controlada.price; // R$ 49,90
