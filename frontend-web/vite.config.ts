...
export default defineConfig({
  ...
  build: {
    outDir: 'dist',
    // 'hidden': gera o .map mas NÃO adiciona o comentário `//# sourceMappingURL`
    // no bundle publicado. O mapa fica disponível para upload manual no Sentry
    // ou para debug local, mas não é descoberto por quem apenas abre o site.
    sourcemap: 'hidden',
