...
export default function PatientLayout() {
  ...
  useRequirePermissions('/(patient)/home');
  ...
  useEffect(() => {
    ...
    // Bloqueia paciente com cadastro incompleto (ex.: novo usuário Google)
    // de acessar a área autenticada sem terminar o onboarding.
    if (!loading && user && user.role === 'patient' && !user.profileComplete) {
