...
const POLICY_SECTIONS = [
  {
    ...
    content: [
      'Receita/exame: Antes da aprovação do médico, é possível cancelar. Se rejeitada pelo médico, entre em contato. Após aprovação, antes do médico assinar: entre em contato. Após assinatura do documento, não há reembolso.',
