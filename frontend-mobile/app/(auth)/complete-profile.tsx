...
export default function CompleteProfileScreen() {
  ...
  // Usuário já está autenticado nesse ponto — exige permissões obrigatórias
  // (também detecta revogação em runtime via AppState).
  useRequirePermissions('/(auth)/complete-profile');
