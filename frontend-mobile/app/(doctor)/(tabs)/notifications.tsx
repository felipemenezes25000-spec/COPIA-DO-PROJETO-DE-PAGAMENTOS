...
function makeStyles(colors: DesignColors, isDark: boolean) {
  return StyleSheet.create({
    container: {
      flex: 1,
      // colors.background já resolve light/dark via useAppTheme — ternária
      // redundante removida (valor idêntico ao hardcoded #F8FAFC em light).
      backgroundColor: colors.background,
    },
    header: {
      // colors.surface = #FFFFFF em light, #1E293B em dark — ternária redundante.
