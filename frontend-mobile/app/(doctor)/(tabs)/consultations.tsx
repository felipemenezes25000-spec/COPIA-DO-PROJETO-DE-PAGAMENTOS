...
function makeCardStyles(colors: DesignColors, shadows: DesignTokens['shadows']) {
  return StyleSheet.create({
    ...
    joinButton: {
      flexDirection: 'row',
      alignItems: 'center',
      // Unificado com colors.success usado nas linhas do liveDot e countText
      // no mesmo arquivo. Antes: '#16A34A' (success 600), agora: #22C55E
      // (success 500) via designSystem — elimina a divergência de verdes.
      backgroundColor: colors.success,
