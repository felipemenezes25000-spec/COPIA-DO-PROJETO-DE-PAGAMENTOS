...
// Mocks adicionais para os eventos RequestClaimed/RequestReleased que o
// provider passou a assinar depois da feature claim first-come-first-serve.
const mockSubscribeClaimed = jest.fn(() => jest.fn());
const mockSubscribeReleased = jest.fn(() => jest.fn());
...
jest.mock('../lib/requestsEvents', () => ({
  ...
  subscribeRequestClaimed: mockSubscribeClaimed,
  subscribeRequestReleased: mockSubscribeReleased,
...
//
// FIX: depois que o RequestsEventsProvider passou a chamar useQueryClient()
// (para invalidar DOCTOR_REQUESTS_QUERY_KEY nos eventos RequestClaimed/
// RequestReleased do SignalR), todo renderHook precisa de um
// QueryClientProvider externo senão explode com "No QueryClient set".
