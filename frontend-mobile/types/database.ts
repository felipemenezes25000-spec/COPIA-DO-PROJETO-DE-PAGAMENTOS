...
export interface RequestResponseDto {
  ...
  /** Fonte da rejeição: "Ai", "Doctor" ou null (não rejeitado). */
  rejectionSource?: string | null;
  /** Motivo gerado pela IA quando o pedido foi rejeitado automaticamente. */
  aiRejectionReason?: string | null;
  /** Timestamp da rejeição automática pela IA. */
