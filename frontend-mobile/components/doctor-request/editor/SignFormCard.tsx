  ...
  return (
    <DoctorCard style={styles.card}>
      ...
      <View style={styles.inputWrap}>
        <TextInput
          style={[styles.input, styles.inputWithIcon, { color: colors.text, backgroundColor: colors.background, borderColor: colors.border }]}
          value={certPassword}
...
const styles = StyleSheet.create({
  ...
  inputWithIcon: { paddingRight: 46, marginBottom: 0 },
  eyeBtn: {
    position: 'absolute',
    right: 10,
    top: 0,
