...
export function evaluateExamCompleteness(input: {
  ...
  // Sintomas/motivo é opcional: se o paciente não preencher, o sistema usa
  // "Investigação diagnóstica" como motivo padrão (req. Carolina Akiko 2026-04-08).
  const items: CompletenessItem[] = [
    ...
    { id: 'symptoms', label: 'Descrever sintomas/indicação clínica (opcional)', required: false, done: symptomLength >= 10 },
