...
public class RequestServiceTests
{
    ...
    private readonly RequestApprovalService _approvalSut;
    ...
    public RequestServiceTests()
    {
        ...
        _approvalSut = requestApprovalService;
        ...
        _sut = new RequestService(
            ...
            new Mock<IRequestRoutingStrategy>().Object,
            _loggerMock.Object);
    }
    ...
    public async Task CreatePrescriptionAsync_ShouldCreateRequest_WhenValid()
    {
        ...
        MedicalRequest? created = null;
        _requestRepoMock
            .Setup(r => r.CreateAsync(It.IsAny<MedicalRequest>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((MedicalRequest req, CancellationToken _) => { created = req; return req; });
        _requestRepoMock
    ...
    public async Task ReopenFromAiRejection_happy_path_transitions_to_InReview_and_pushes_patient()
    {
        ...
        _pushDispatcherMock.Verify(
            p => p.SendAsync(
                It.Is<RenoveJa.Application.DTOs.Notifications.PushNotificationRequest>(
                    req => req.Payload.Type == "request_reopened_for_review"),
