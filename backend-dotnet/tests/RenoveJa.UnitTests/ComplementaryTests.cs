...
public class AuthServiceExtendedTests
{
    ...
    public async Task ForgotPasswordAsync_ShouldNotThrow_WhenUserNotFound()
    {
        ...
        Func<Task> act = () => _sut.ForgotPasswordAsync("unknown@e.com");
    ...
    public async Task RegisterDoctorAsync_ShouldCreateDoctorAndProfile()
    {
        var request = new RegisterDoctorRequestDto(
            ...
            new DateTime(1985, 3, 10), null, null, null, "Rua Teste", "100", "Centro", null, "São Paulo", "SP", "01310100");

        _userRepoMock.Setup(r => r.ExistsByEmailAsync(It.IsAny<string>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(false);
        _userRepoMock.Setup(r => r.ExistsByCpfAsync(It.IsAny<string>(), It.IsAny<UserRole>(), It.IsAny<Guid?>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(false);
    ...
    public async Task RegisterDoctorAsync_ShouldThrow_WhenEmailExists()
    {
        ...
        var request = new RegisterDoctorRequestDto(
            ...
            new DateTime(1980, 1, 1), null, null, null, "Rua X", "1", "Bairro", null, "São Paulo", "SP", "01310100");
...
public class RequestServiceFullTests
{
    ...
    private readonly Mock<RenoveJa.Application.Services.Routing.IRequestRoutingStrategy> _routingStrategyMock = new();
    ...
    public RequestServiceFullTests()
    {
        ...
        _sut = new RequestService(
            ...
            new SignatureService(
                ...
                new Mock<ILogger<SignatureService>>().Object),
    ...
    public async Task AssignToQueueAsync_ShouldAssignFirstAvailableDoctor()
    {
        ...
        _requestRepoMock.Setup(r => r.GetByIdAsync(request.Id, It.IsAny<CancellationToken>())).ReturnsAsync(request);
        _routingStrategyMock.Setup(r => r.SelectDoctorAsync(
                It.IsAny<RenoveJa.Application.Services.Routing.RoutingContext>(),
                It.IsAny<CancellationToken>()))
            .ReturnsAsync(new RenoveJa.Application.Services.Routing.RoutingDecision(
                doctorProfileId, doctorUserId, doctorUser.Name, "Clínica"));
        _doctorRepoMock.Setup(r => r.UpdateLastAssignedAtAsync(
