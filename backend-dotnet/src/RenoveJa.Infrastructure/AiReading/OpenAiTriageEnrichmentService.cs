...
public class OpenAiTriageEnrichmentService : ITriageEnrichmentService
{
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            using var response = await PostWithRetryAsync(client, baseUrl, json, cancellationToken);
            ...
            // BUG FIX: acesso direto via GetProperty lançava KeyNotFoundException em
            // respostas sem o schema esperado (erro, rate-limit, provider alternativo).
            string? message = null;
