...
public class OpenAiConductSuggestionService : IAiConductSuggestionService
{
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            using var response = await client.PostAsync($"{baseUrl}/chat/completions", content, cancellationToken);
            ...
            // BUG FIX: acesso encadeado via GetProperty lançava KeyNotFoundException em
            // respostas degradadas (rate-limit, schema alternativo, erro do provider).
            // Agora valida cada nó antes de acessar e trata como falha silenciosa.
            string? message = null;
