...
public class PostgresClient
{
    ...
    /// <summary>
    /// doctor_ai_analyses: pontos_fortes e pontos_fracos são JSONB (arrays de strings).
    /// </summary>
    private static readonly HashSet<string> JsonbColumnsDoctorAiAnalyses = new(StringComparer.OrdinalIgnoreCase)
    {
    ...
    private static bool NeedsJsonbCast(string tableName, string columnName)
    {
        ...
        if (tableName.Equals("doctor_ai_analyses", StringComparison.OrdinalIgnoreCase))
            return JsonbColumnsDoctorAiAnalyses.Contains(columnName);
        return false;
    }
