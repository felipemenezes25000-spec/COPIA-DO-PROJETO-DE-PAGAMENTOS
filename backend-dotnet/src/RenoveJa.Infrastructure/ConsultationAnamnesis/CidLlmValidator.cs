...
Lembre-se: valide APENAS com base no que o paciente DISSE, não em inferências.";
        ...
        try
        {
            ...
            // BUG FIX: acesso direto via GetProperty estourava KeyNotFound quando a API
            // devolvia payload alternativo (ex.: rate-limit, mudança de schema Gemini).
            ...
            {
                responseContent = contentEl.GetString() ?? "";
            }
