...
public record RequestResponseDto(
    ...
    /// <summary>Fonte da rejeição: "Ai", "Doctor" ou null (não rejeitado).</summary>
    string? RejectionSource = null,
    string? AiRejectionReason = null,
    DateTime? AiRejectedAt = null,
    Guid? ReopenedBy = null,
...
/// Nível de confidencialidade: "general" (padrão, visível para qualquer médico),
/// "specialty_only" (visível só para mesma especialidade), "author_only"
/// (visível só para o autor — outros recebem apenas <paramref name="SummaryForTeam"/>).
/// </param>
/// <param name="IsMaskedForViewer">
/// Quando <c>true</c>, <paramref name="Content"/> não é o texto bruto — foi substituído
/// pelo resumo clínico seguro porque o visualizador não tem acesso à nota completa.
/// </param>
...
/// <param name="Sensitivity">
/// "general" (padrão) | "specialty_only" | "author_only".
/// Obrigatório usar "author_only" para psicoterapia (CFP 001/2009) e conteúdo
/// sensível de saúde mental (Lei 10.216/2001).
/// </param>
/// <param name="SummaryForTeam">
/// Resumo clínico seguro compartilhável com a equipe quando a nota principal é
/// "author_only". Recomendado para não bloquear totalmente a visibilidade da
