...
public record MedicalCertificateEmitDto
{
    ...
    /// <remarks>
    /// FIX M4: valida 1..365. Sem esse range, o ModelBinder aceitava 0 ou
    /// negativos (ex: front passa leaveDays = -5 por bug de stepper), o
    /// backend salvava e emitia atestado inválido, que depois era rejeitado
    /// silenciosamente pelos empregadores/ITI. Limite 365 evita atestado
    /// clinicamente irrealista (afastamento maior que 1 ano precisa de
    /// processo especial pelo INSS, não atestado simples).
    /// </remarks>
    [Range(1, 365, ErrorMessage = "Dias de afastamento deve estar entre 1 e 365.")]
