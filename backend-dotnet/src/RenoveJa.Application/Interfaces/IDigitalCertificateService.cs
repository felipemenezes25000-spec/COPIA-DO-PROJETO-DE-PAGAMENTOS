...
public interface IDigitalCertificateService
{
    ...
    /// storagePath: path completo no S3 (ex.: pedidos/{requestId}/receita/assinado/receita-{requestId}.pdf).
    /// pfxPassword: senha do certificado PFX. Obrigatória para desbloquear a chave privada.
    /// documentTypeHint: "prescription" ou "exam" — define OID ITI para validar.iti.gov.br.
    /// </summary>
