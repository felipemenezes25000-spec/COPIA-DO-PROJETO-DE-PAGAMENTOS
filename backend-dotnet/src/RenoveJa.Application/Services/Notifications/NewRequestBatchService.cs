...
public class NewRequestBatchService : BackgroundService, INewRequestBatchService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            // BUG FIX: on host shutdown Task.Delay throws TaskCanceledException which previously
            // escaped ExecuteAsync and bubbled up as an unhandled exception in logs.
            try
            {
