    ...
    ILogger<ExceptionHandlingMiddleware> logger)
{
    ...
    private static Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        var (statusCode, message) = exception switch
        {
            ...
            // Senha do PFX inválida: expor a mensagem real mesmo em produção para que o médico
            // entenda que o problema é só a senha (e não um erro interno do sistema).
            SignatureInvalidPfxPasswordException => (HttpStatusCode.BadRequest, exception.Message),
