...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddRepositories(this IServiceCollection services)
    {
        ...
        services.AddScoped<IDoctorAiAnalysisRepository, DoctorAiAnalysisRepository>();
        services.AddScoped<IDoctorAdminNoteRepository, DoctorAdminNoteRepository>();
        services.AddScoped<IDoctorPatientNotesRepository, DoctorPatientNotesRepository>();
        services.AddScoped<IOutboxEventRepository, OutboxEventRepository>();

        // ===== COPIA-ONLY: Payment, CarePlan, SUS repositories =====
        ...
        // Monitor de Produtividade (portal RH).
        ...
        services.AddScoped<IDoctorContractRepository, DoctorContractRepository>();
    ...
    public static IServiceCollection AddApplicationServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<IRequestRoutingStrategy, CompositeRoutingStrategy>();
        ...
        // ===== COPIA-ONLY: Payment and CarePlan services =====
        ...
        services.AddScoped<ICarePlanService, RenoveJa.Application.Services.CarePlans.CarePlanService>();
    ...
    public static IServiceCollection AddInfrastructureServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<IRhAiService, OpenAiRhAiService>();
        services.AddScoped<RenoveJa.Application.Services.Clinical.IPatientClinicalHistoryService, RenoveJa.Application.Services.Clinical.PatientClinicalHistoryService>();
        ...
        // ===== COPIA-ONLY: MercadoPago, RNDS, Ledi, WhatsApp =====
        services.AddScoped<IMercadoPagoService, RenoveJa.Infrastructure.Payments.MercadoPagoService>();
        services.AddScoped<IRndsService, RenoveJa.Infrastructure.Rnds.RndsService>();
        services.AddScoped<ILediExportService, RenoveJa.Infrastructure.Ledi.LediExportService>();
        services.AddScoped<IWhatsAppService, RenoveJa.Infrastructure.WhatsApp.WhatsAppService>();
