...
public class CertificatesController : ControllerBase
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // Nota: Forbid(string) interpreta o argumento como AuthenticationScheme e
        // lança InvalidOperationException em runtime. Usamos StatusCode(403) com corpo.
        if (!_currentUserService.IsDoctor())
            return StatusCode(403, new { error = "Apenas médicos podem cadastrar certificados digitais." });
