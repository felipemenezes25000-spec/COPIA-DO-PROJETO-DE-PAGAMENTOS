...
public class User : AggregateRoot
{
    ...
    /// <summary>
    /// Cria um usuário administrador (painel RH). Não exige CPF nem telefone —
    /// o admin é um operador interno cujo único papel é aprovar/rejeitar médicos.
    /// Usado exclusivamente pelo <c>AdminSeeder</c> durante o startup.
    /// </summary>
