...
public class DoctorCertificate : Entity
{
    ...
    public static DoctorCertificate Reconstitute(
        ...
        DateTime createdAt)
    {
        var normalizedNotBefore = notBefore.Kind == DateTimeKind.Utc
            ? notBefore
            : DateTime.SpecifyKind(notBefore, DateTimeKind.Utc);
        var normalizedNotAfter = notAfter.Kind == DateTimeKind.Utc
            ? notAfter
            : DateTime.SpecifyKind(notAfter, DateTimeKind.Utc);
